...
func (e *CodexExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	if httpResp.StatusCode < 200 || httpResp.StatusCode >= 300 {
		...
		helps.RecordCodexAuthHealthResponse(e.cfg, auth, e.Identifier(), httpResp.StatusCode, httpResp.Header, b)
		helps.LogWithRequestID(ctx).Debugf("request error, error status: %d, error message: %s", httpResp.StatusCode, helps.SummarizeErrorBody(httpResp.Header.Get("Content-Type"), b))
		err = newCodexStatusErr(httpResp.StatusCode, b)
		return resp, err
	}
	helps.RecordCodexAuthHealthResponse(e.cfg, auth, e.Identifier(), httpResp.StatusCode, httpResp.Header, nil)
...
func (e *CodexExecutor) ExecuteStream(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (_ *cliproxyexecutor.StreamResult, err error) {
	...
	if httpResp.StatusCode < 200 || httpResp.StatusCode >= 300 {
		...
		helps.AppendAPIResponseChunk(ctx, e.cfg, data)
		helps.RecordCodexAuthHealthResponse(e.cfg, auth, e.Identifier(), httpResp.StatusCode, httpResp.Header, data)
